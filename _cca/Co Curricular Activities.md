...
<p>Students are discouraged from changing their CCA as they need time to
build knowledge and master their skills in the CCA. Requests for a change
of CCA will only be considered at the start of P4 after the students had
spent 1 Semester in their CCA.</p>
<p>To change CCA, the student will need to fill in the CCA Transfer Form
which can be obtained through their current CCA teacher. All transfer cases
must be supported by a valid reason, e.g. by means of a parent/guardian’s
email to SH PE &amp; CCA. The transfer of CCA will be subjected to evaluation
by the current CCA OIC and the new CCA OIC, as well as availability of
vacancy in the new CCA. After the approval by the SH PE &amp; CCA, an official
notification will be given to the student through the Form Teacher, to
inform parents/guardians the outcome of the transfer request. While the
evaluation process of the transfer request takes place, the student is
expected to continue his/her current CCA activities.</p>
...
<p>CCA training sessions will include Social Emotional Learning lessons to
provide opportunities to develop SEL competencies in our students once
per semester. The 5 domains that are integral to the SEL lessons are Self-Awareness,
